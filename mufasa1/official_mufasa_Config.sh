...
GALSF_JEANS_MIN_T=1                  # disallows cooling below N x T_Jeans
...
GALSF_SUBGRID_RECOUPLE=0.5	# recouple when dv<RECOUPLE*csound 
...
GALSF_SUBGRID_MSWIND=-0.351     # scale eta with Mstar^GALSF_SUBGRID_MSWIND
GALSF_SUBGRID_MSNORM=3.55    # normalization of eta at Mstar=1e10; Muratov+15 suggests 3.55
GALSF_SUBGRID_FIREVEL=2.0      # normalization of velocity scaling; Muratov+15 suggests 0.854
#GALSF_SUBGRID_ETAHISLOPE=0     # additional power law index for eta for M*>1.e10
GALSF_SUBGRID_VBOOST=0.25	# boost velocity to this radius (rel. to r200)
#SIGMASFR_WIND=0.1              # Only have wind if above this SFR surface density (code units)
...
#GALSF_SFR_KMT_METALFLOOR=0.001  # metal floor in Zsun for fH2 calc only -- DEPRECATED to 0.001
...
BH_BAL_KICK_MOMENTUM_FLUX=1   # DAA: increase the effective mass-loading of BAL winds to reach the desired momentum flux in units of L_bol/c (needs BH_BAL_KICK)
